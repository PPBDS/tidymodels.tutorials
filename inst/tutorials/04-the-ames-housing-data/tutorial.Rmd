...
```{r exploring-features-o-1-hint-1, eval = FALSE}
library(...)
```
...
```{r exploring-features-o-2-hint-1, eval = FALSE}
data(...)
```
...
```{r exploring-features-o-3-hint-1, eval = FALSE}
dim(...)
```
...
```{r exploring-features-o-4-hint-1, eval = FALSE}
ames
```
...
```{r exploring-features-o-5-hint-1, eval = FALSE}
ames |>
  ...()
```
...
```{r exploring-features-o-6-hint-1, eval = FALSE}
... |>
  ggplot(aes(x = ...))
```
...
```{r exploring-features-o-7-hint-1, eval = FALSE}
... +
  geom_histogram()
```
...
```{r exploring-features-o-8-hint-1, eval = FALSE}
... +
  geom_histogram(bins = ...)
```
...
```{r exploring-features-o-9-hint-1, eval = FALSE}
... +
...
```{r exploring-features-o-10, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r exploring-features-o-10-hint-1, eval = FALSE}
... +
  scale_x_...()
```
