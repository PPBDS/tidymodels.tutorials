...
<!-- DK: Don't use "our" or "we", unless you are talking about us, the authors of the tutorial. -->
...
The reason this code throws an error is because the `fit()` function has a required `formula` argument; we haven`t passed in any formula yet.
