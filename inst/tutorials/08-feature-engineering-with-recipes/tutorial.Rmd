...
<!-- AK: Getting a warning message here and unsure of how to fix it. DK: Explain it when it happens. -->
...
As you can, the code outputs a list of predicted sale prices based on the neighborhood, year built, building type, and area.
