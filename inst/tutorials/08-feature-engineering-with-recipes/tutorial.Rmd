...
```{r using-recipies-8, exercise = TRUE}

```

```{r using-recipies-8-hint, eval = FALSE}
lm_fit |>
  ...(estimated = ...)
```
...
```{r using-recipies-9, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r using-recipies-9-hint, eval = FALSE}
lm_fit |>
  ...()
```
...
```{r using-recipies-10, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r using-recipies-10-hint, eval = FALSE}
