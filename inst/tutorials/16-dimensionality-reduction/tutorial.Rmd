...
# AK: A lot of the code in the "Modeling" Section requires the mixOmics package, which isn't on CRAN. Would it be possible to install and use this package?
...
```{r}
knitr::include_graphcis("images/pic5.png")
```
