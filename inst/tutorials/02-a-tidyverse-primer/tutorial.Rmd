...
<!-- DK: Spaces around |> always. -->

<!-- DK: Figure out which tests are taking so long. -->

<!-- DK: Change read_csv(url) as the beginng of the pipe. Instead, download the data once, then build the pipe starting from that data set. -->
