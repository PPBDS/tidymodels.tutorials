...
Here's another way to load the **modeldata** package and `crickets` tibble:
...
<!-- DK: Insert code here creating cricket plot, and assigning it to an object. Then, print the object. Then print the object again at the end. -->
...
<!-- DK: These should be two exercises, with instructions. Students should type. -->
