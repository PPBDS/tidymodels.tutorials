...
These were the variables created in the "Grid Search" tutorial, and will be used for this tutorial. `cells` is a tibble that consists of 56 imaging measurements on 2019 human breast cancer cells. These predictors represent shape and intensity characteristics of different parts of the cells.

Because of the high degree of correlation between predictors, PCA feature extraction was used to decorrelate the predictors.

### Exercise 5

Let's create three tidymodel objects: `svm_rec`, `svm_spec`, and `svm_wflow`.
...
[Section 14.2.3](https://www.tmwr.org/iterative-search) of [*Tidy Modeling with R*](https://www.tmwr.org/index.html) shows a visualization of this search.
...
[Section 14.3.2](https://www.tmwr.org/iterative-search) of [*Tidy Modeling with R*](https://www.tmwr.org/index.html) shows a visualization of the search path, which helps to understand where the search process did well and where it went astray.
