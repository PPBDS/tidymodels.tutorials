...
The goal of tidymodels.tutorials is to …

## Installation

You can install the development version of tidymodels.tutorials from
[GitHub](https://github.com/) with:

``` r
# install.packages("devtools")
devtools::install_github("PPBDS/tidymodels.tutorials")
```
